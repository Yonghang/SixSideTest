...
// */
//class SpecailGroupView extends ViewGroup {
//    private static final String TAG = SpecailGroupView.class.getSimpleName();
//
...
//
//    public SpecailGroupView(Context context) {
//        super(context);
//    }
//
//    public SpecailGroupView(Context context, AttributeSet attrs) {
//        super(context, attrs);
//    }
//
//    public SpecailGroupView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        }
//        Log.i(TAG, "onLayout()--changed=" + changed + ",left=" + left + ",top=" + top + ",right=" + right + ",bottom=" + bottom + ",count=" + count);
//    }
//
...
//    }
//
//    public void setOnItemClick(SpecailItemView.OnClickListener l) {
//        int count = getChildCount();
//        for (int i = 0; i < count; i++) {
//            ((SpecailItemView) getChildAt(i)).setOnClickListener(l);
//        }
//    }
//
//    private List<CircleCenteter> centers = new LinkedList<>();
//
