...
// */
//class SixSideImageView extends ImageView {
//    private static final String TAG = SixSideImageView.class.getSimpleName();
//
//    public SixSideImageView(Context context) {
//        super(context);
//    }
//
//    public SixSideImageView(Context context, AttributeSet attrs) {
//        super(context, attrs);
//    }
//
//    public SixSideImageView(Context context, AttributeSet attrs, int defStyleAttr) {
